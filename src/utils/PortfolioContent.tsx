import sample1 from "../assets/images/test.png";
...
export const PortfolioContent = [
  {
    ...
    content: {
      ...
      explanation: [
        ...
        영화 리스트는 현재 상영 중인, 가장 인기있는, 개벙 예정인 영화 리스트를 호출했습니다. 쿼리에 language를 넣어 한국어로 된 영화 리스트를 받을 수 있게 요청했습니다.\n
        
        영화에 마우스오버를 하면 영화의 제목과 별점이 나타납니다.\n
        
        carousel을 구현하기위해 react-slick라이브러리를 사용했습니다. 기본 carousel에서 넷플릭스와 어울리도록 커스터마이징을 하였습니다.\n`,
        "2. 설명은 이렇고 저렇고",
      ],
    },
