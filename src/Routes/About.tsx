        ...
        <MiddleWrapper>
          <IntroduceSkillWrapper>
            <Introduce>
              ...
              직관적이고 시각적인 기능을 구현하는 창의적인 작업을 하는 것에 관심이 끌려 프론트엔드에 도전하게 되었습니다. 프론트엔드 개발을 위해 온라인 강의를 수강하면서 만들었던 프로젝트들을 완성해가며 성취감을 느꼈고 사용자 친화적인 디자인과 기능을 구현하며 성취감을 느끼는 것이 앞으로 프론트엔드 개발로 성장할 수 있는 원동력이 된다고 생각합니다. 그렇기 때문에 이러한 부분들을 활용하여 프론트엔드 업무를 진행하고 싶습니다. 
